---
title: "MentalHealth_logisticregression"
output: pdf_document
date: "2023-02-06"
---
...
logit.reg <- glm(formula = treatment ~ Age + Gender+ no_employees+work_interfere+family_history+self_employed+benefits+care_options+mental_health_interview+seek_help+anonymity,data = train.df, family = "binomial") 
summary(logit.reg)
